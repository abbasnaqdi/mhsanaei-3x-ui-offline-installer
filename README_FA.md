...
- **🔄 پایداری بی‌نهایت شبکه:** دانلودر کاملاً مقاوم در برابر قطعی که در صورت قطع شدن اینترنت تسلیم نشده و تلاش برای دانلود را به صورت مداوم ادامه می‌دهد.
- **🔒 مدیریت پیشرفته SSL:** 
  - تولید **Self-Signed** با قابلیت **Dynamic** (ساخت گواهینامه در سرور مقصد و جای‌گذاری هوشمند آی‌پی سرور).
  - صدور گواهینامه **Let's Encrypt (DNS-01)** (دریافت مستقیم گواهینامه معتبر با پشتیبانی ۱۰۰٪ از تنظیمات پروکسی برای صحت‌سنجی DoH).
  - قابلیت وارد کردن گواهینامه‌های سفارشی.
